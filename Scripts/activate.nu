...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Gaming PC\PycharmProjects\zero_sum\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Gaming PC\PycharmProjects\zero_sum\venv\Scripts\deactivate.nu'
